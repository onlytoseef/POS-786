...
export const exportToPDF = (options: ExportOptions) => {
    ...
    // Company Header
    doc.setFillColor(36, 42, 42); // #242A2A
    doc.rect(0, 0, pageWidth, 35, 'F');

    doc.setTextColor(235, 224, 192); // #EBE0C0
    doc.setFontSize(22);
    doc.setFont('helvetica', 'bold');
    doc.text('TRACTOR SPARE PARTS', pageWidth / 2, 15, { align: 'center' });

    doc.setFontSize(10);
    doc.setFont('helvetica', 'normal');
    doc.text('Wholesale Import & Export | Authorized Dealer', pageWidth / 2, 22, { align: 'center' });
    doc.text('Phone: +92-XXX-XXXXXXX | Email: info@tractorparts.pk', pageWidth / 2, 28, { align: 'center' });
    ...
    autoTable(doc, {
        ...
        headStyles: {
            fillColor: [36, 42, 42], // #242A2A
            textColor: [235, 224, 192], // #EBE0C0
            fontStyle: 'bold',
            halign: 'center',
        },
        alternateRowStyles: {
