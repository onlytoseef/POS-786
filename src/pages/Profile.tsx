        ...
        <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-1">
                    ...
                    >
                        <div className="h-24" style={{ backgroundColor: '#242A2A' }}></div>
                        <div className="relative px-6 pb-6">
                            ...
                            <h2 className="text-xl font-bold mt-4" style={{ color: '#242A2A' }}>
                                {profile?.name}
                            </h2>
                            ...
                            <div className="mt-4 space-y-3">
                                <div className="flex items-center gap-3">
                                    <FaEnvelope className="text-sm" style={{ color: '#6B7280' }} />
                                    <span className="text-sm" style={{ color: '#242A2A' }}>{profile?.email}</span>
                                </div>
                                <div className="flex items-center gap-3">
                                    <FaCalendar className="text-sm" style={{ color: '#6B7280' }} />
                                    <span className="text-sm" style={{ color: '#242A2A' }}>
                ...
                <div className="lg:col-span-2">
                    ...
                    >
                        {/* Tabs */}
                        <div className="flex border-b" style={{ borderColor: '#EBE0C0' }}>
                            <button
                                ...
                                style={{
                                    color: activeTab === 'profile' ? '#242A2A' : '#6B7280',
                                    borderColor: activeTab === 'profile' ? '#242A2A' : 'transparent',
                                    backgroundColor: activeTab === 'profile' ? '#FAFAF5' : 'transparent',
                                }}
                            >
                            ...
                            <button
                                ...
                                style={{
                                    color: activeTab === 'password' ? '#242A2A' : '#6B7280',
                                    borderColor: activeTab === 'password' ? '#242A2A' : 'transparent',
                                    backgroundColor: activeTab === 'password' ? '#FAFAF5' : 'transparent',
                                }}
                            >
                                ...
                                <form onSubmit={handleProfileUpdate}>
                                    <div className="flex items-center gap-3 mb-6">
                                        <div 
                                            ...
                                            style={{ backgroundColor: '#EBE0C0' }}
                                        >
                                            <FaUser style={{ color: '#242A2A' }} />
                                        </div>
                                        <div>
                                            <h3 className="font-semibold" style={{ color: '#242A2A' }}>
                                                Profile Information
                                            </h3>
                                ...
                                <form onSubmit={handlePasswordChange}>
                                    <div className="flex items-center gap-3 mb-6">
                                        <div 
                                            ...
                                            style={{ backgroundColor: '#EBE0C0' }}
                                        >
                                            <FaShieldAlt style={{ color: '#242A2A' }} />
                                        </div>
                                        <div>
                                            <h3 className="font-semibold" style={{ color: '#242A2A' }}>
                                                Security Settings
                                    ...
                                    <div className="mt-4 p-3 rounded-lg" style={{ backgroundColor: '#FAFAF5' }}>
                                        <p className="text-xs font-medium mb-2" style={{ color: '#242A2A' }}>
                                            Password Requirements:
                                        </p>
