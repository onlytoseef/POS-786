...
const PrintInvoice = forwardRef<HTMLDivElement, PrintInvoiceProps>(
    ({ invoice, items, invoiceType, companyInfo }, ref) => {
        ...
        const company = companyInfo || {
            name: '786 Tractor Spare Parts',
            address: 'Main GT Road, Gujranwala, Punjab, Pakistan',
            phone: '+92 300 1234567',
            email: 'info@786spareparts.com',
        };
        ...
        return (
            ...
            >
                {/* Header */}
                <div style={{ borderBottom: '3px solid #242A2A', paddingBottom: '8px', marginBottom: '12px' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                        ...
                        <div style={{ textAlign: 'right' }}>
                            <h2 style={{ 
                                ...
                                fontSize: '16px', 
                                fontWeight: 'bold',
                                color: invoiceType === 'import' ? '#1E40AF' : '#047857',
