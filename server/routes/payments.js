...
router.post('/supplier-payment', authorization, async (req, res) => {
    ...
    try {
        ...
        const paymentResult = await client.query(`
            INSERT INTO payments (type, partner_id, amount, method, reference_id)
            VALUES ('supplier', $1, $2, 'cash', $3)
            RETURNING *
        `, [supplier_id, amount, reference]);
...
router.post('/credit-voucher', authorization, async (req, res) => {
    ...
    try {
        ...
        const voucherResult = await client.query(`
            INSERT INTO payments (type, partner_id, amount, method, reference_id)
            VALUES ('customer', $1, $2, 'credit_voucher', $3)
            RETURNING *
